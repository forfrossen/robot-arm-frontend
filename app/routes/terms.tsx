  ...
  return (
    ...
    >
      ...
      <Typography gutterBottom>
        ...
        <Link href={appOrigin}>{appOrigin}</Link> and any related services provided by {appName}.
      </Typography>
      <Typography gutterBottom>
        By accessing <Link href={appOrigin}>{appOrigin}</Link>, you agree to abide by these Terms of
        Service and to comply with all applicable laws and regulations. If you do not agree with
        these Terms of Service, you are prohibited from using or accessing this website or using any
        other services provided by {appName}.
      </Typography>
      <Typography gutterBottom>
        We, {appName}, reserve the right to review and amend any of these Terms of Service at our
      ...
      <ol>
        ...
        <li>
          ...
          abuses or disrupts our networks or any other service {appName} provides;
        </li>
        <li>
      ...
      <Typography gutterBottom>
        ...
        licensed to {appName} and are protected by applicable copyright and trademark law. We grant
      ...
      <Typography gutterBottom>
        ...
        and may be terminated by {appName}
        at any time.
      </Typography>
      <Typography level="h2" gutterBottom>
        Liability
      ...
      <Typography gutterBottom>
        ...
        To the extent permitted by law, {appName} makes no warranties, expressed or implied, and
      ...
      <Typography gutterBottom>
        In no event shall {appName} or its suppliers be liable for any consequential loss suffered
        or incurred by you or any third party arising from the use or inability to use this website
        or the materials on this website, even if {appName} or an authorized representative has been
      ...
      <Typography gutterBottom>
        ...
        purposes only. {appName} does not warrant or make any representations concerning the
      ...
      <Typography gutterBottom>
        {appName} has not reviewed all of the sites linked to its website and is not responsible for
        the contents of any such linked site. The inclusion of any link does not imply endorsement,
        approval, or control by
        {appName} of the site. Use of any such linked site is at your own risk and we strongly
      ...
      <Typography gutterBottom>
        ...
        States. You irrevocably submit to the exclusive jurisdiction of the courts in that State or
        location.
      </Typography>
    </Container>
  );
