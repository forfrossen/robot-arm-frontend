...
import { AnyRootConfig, AnyRouterDef, createCallerFactory, Router } from "@trpc/server";
...
export function createClient<TRouter extends Router<AnyRouterDef<AnyRootConfig>>>(
  router: TRouter,
